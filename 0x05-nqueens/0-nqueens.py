#!/usr/bin/python3
""" Module for Solving n queens """


import sys


# The error handling for argv[1]
...
# The N queens methods

    coords = []

    def isSafe(coords, row, col):
        """ This method checks if queen can be placed in coord of board.
    ...
    def solveNqueens(coords, col, safe_queens=[]):
        """ This method creates array of queen positions
        Returns array
        """
